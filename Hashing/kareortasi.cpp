...
void kareortasi::dizileri_hazirla(void)
{
...
void kareortasi::sirala(void)
{
	...
	if(ogrenci::numara[x]==0) break;
		...
		hash=(ogrenci::numara[x]/10000000*ogrenci::numara[x])%1000;
...
void kareortasi::dosyayayaz(void)
{

	FILE *dosya;
	dosya = fopen("kareortasi.txt", "w");
